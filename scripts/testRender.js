...
function getPresetOptions(presetName) {
  ...
  const presets = {
    ...
    mystical: {
      ...
      glowIntensity: 0.6,
      glowRadius: 12,
      // Colors: deep purple/blue with golden accents
      branchColor: new ColorPicker(ColorPicker.SelectionType.colorBucket),
      accentColor: new ColorPicker(ColorPicker.SelectionType.colorBucket),
      glowColor: new ColorPicker(ColorPicker.SelectionType.colorBucket),
    },
    minimal: {
      ...
      glowIntensity: 0.2,
      glowRadius: 4,
      // Colors: simple monochrome with subtle glow
      branchColor: new ColorPicker(ColorPicker.SelectionType.colorBucket),
      accentColor: new ColorPicker(ColorPicker.SelectionType.colorBucket),
      glowColor: new ColorPicker(ColorPicker.SelectionType.colorBucket),
    },
...
🎨 CONFIGURATION:
  ...
  try {
    ...
    if (!presetConfig.glowColor) presetConfig.glowColor = new ColorPicker(ColorPicker.SelectionType.colorBucket);
